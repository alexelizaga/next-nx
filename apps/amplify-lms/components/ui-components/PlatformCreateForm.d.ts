...
import { Product } from '@/amplify-lms/API.js';
...
export declare type PlatformCreateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: PlatformCreateFormInputValues
    ) => PlatformCreateFormInputValues;
...
>;
export default function PlatformCreateForm(
  props: PlatformCreateFormProps
): React.ReactElement;
